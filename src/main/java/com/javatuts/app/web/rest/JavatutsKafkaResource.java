...
@RestController
@RequestMapping("/api/javatuts-kafka")
public class JavatutsKafkaResource {
    private final Logger log = LoggerFactory.getLogger(JavatutsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JavatutsKafkaResource(KafkaProperties kafkaProperties) {
